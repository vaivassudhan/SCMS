...
const DefaultRenderer = /*#__PURE__*/goober.css({
  "& input,& span": {
 ...
 */
const ItemContainer = /*#__PURE__*/goober.css({
 ...
 */
const SelectListUl = /*#__PURE__*/goober.css({
  margin: 0,
  paddingLeft: 0,
  li: {
    listStyle: "none",
...
const SelectSearchContainer = /*#__PURE__*/goober.css({
  width: "100%",
  position: "relative",
...
const SearchClearButton = /*#__PURE__*/goober.css({
  cursor: "pointer",
  position: "absolute",
  top: 0,
  right: 0,
...
const NoOptions = /*#__PURE__*/goober.css({
  padding: "var(--rmsc-p)",
  textAlign: "center",
  color: "var(--rmsc-gray)"
});
...
const SelectPanel = () => {
  ...
  const [focusIndex, setFocusIndex] = React.useState(focusSearchOnOpen && !disableSearch ? FocusType.SEARCH : FocusType.NONE);
  ...
  }, ClearIcon || React__default.createElement(Cross, null))), hasSelectAll && hasSelectableOptions && React__default.createElement(SelectItem, {
...
const Spinner = /*#__PURE__*/goober.css({
 ...
 */
const PanelContainer = /*#__PURE__*/goober.css({
  position: "absolute",
  zIndex: 1,
  top: "100%",
  width: "100%",
...
const DropdownContainer = /*#__PURE__*/goober.css({
  position: "relative",
  outline: 0,
...
const DropdownHeading = /*#__PURE__*/goober.css({
  position: "relative",
  padding: "0 var(--rmsc-p)",
  display: "flex",
  alignItems: "center",
...
const ClearSelectedButton = /*#__PURE__*/goober.css({
  cursor: "pointer",
  background: "none",
  border: 0,
  padding: 0,
...
const MultiSelectBox = /*#__PURE__*/goober.css({
  "--rmscMain": "#4285f4",
  "--rmscHover": "#f1f3f5",
  "--rmscSelected": "#e2e6ea",
  "--rmscBorder": "#ccc",
