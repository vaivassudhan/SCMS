...
var Picker = function (_React$Component) {
    ...
    function Picker() {
        ...
        _this.getCascade = function (cascade, data, cols, itemStyle, indicatorStyle) {
            ...
            var popupMoreProps = {};
            if (cascade) {
                cascader = _react2['default'].createElement(_cascader2['default'], { data: Array.isArray(data[0]) ? data[0] : data, cols: cols, onChange: _this.onPickerChange, onScrollChange: _this.setCasecadeScrollValue, pickerItemStyle: itemStyle, indicatorStyle: indicatorStyle });
            } else {
