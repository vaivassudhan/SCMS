...
var _reactNativePagerView = require('react-native-pager-view');

var _reactNativePagerView2 = _interopRequireDefault(_reactNativePagerView);
...
var Tabs = exports.Tabs = function (_React$PureComponent) {
    ...
    function Tabs(props) {
        ...
        _this.renderContent = function () {
            ...
            return _react2['default'].createElement(
                _reactNativePagerView2['default'],
    ...
    (0, _createClass3['default'])(Tabs, [{
        ...
        value: function render() {
            ...
            var tabBarProps = (0, _extends3['default'])((0, _extends3['default'])({}, this.getTabBarBaseProps()), { keyboardShouldPersistTaps: keyboardShouldPersistTaps, scrollX: scrollX, scrollValue: scrollValue, containerWidth: containerWidth });
            if (overlayTabs) {
                // tabBarProps.style = {
                //     position: 'absolute',
                //     left: 0,
